...
export const metadata: Metadata = {
  title: "Privacy Policy - EliteFut",
  description: "Read the Privacy Policy for EliteFut. Learn how we collect, use, and safeguard your personal information.",
};
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-on-surface-variant leading-relaxed text-sm md:text-base">
          <section className="space-y-4">
            <h2 className="text-2xl font-headline font-bold text-white border-b border-outline-variant/20 pb-2">
              1. Introduction
              <span className="material-symbols-outlined align-middle ml-2 text-primary text-lg">security</span>
            </h2>
            <p>
              At EliteFut (accessible via <a href="https://www.elitefutbot.com/" className="text-primary hover:underline">https://www.elitefutbot.com/</a>), we respect your privacy and are committed to protecting any personal data we process. This Privacy Policy explains how we collect, use, disclose, and protect your information when you visit or use our website, tools, and browser companion services.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Billing Information:</strong> If you purchase a subscription, all credit card and transactional information is processed securely by our third-party payment gateways. **We do not store your credit card or financial account numbers on our servers.** We only receive a transaction confirmation token.</li>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>To provide, operate, and maintain our SBC helper and market dashboard tools.</li>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Payment Processors:</strong> We use payment processors to handle transactions securely. These processors operate under their own strict security protocols and privacy policies.</li>
