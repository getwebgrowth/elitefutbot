      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center space-y-4 mb-16 max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-surface-container-high px-4 py-1.5 rounded-lg border border-outline-variant/20">
            ...
            <span className="text-xs font-label font-bold uppercase tracking-widest text-primary-fixed-dim">Support Network</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-headline font-extrabold tracking-tight">
            Contact <span className="text-primary-container">Support</span>
          </h1>
          <p className="text-on-surface-variant text-base md:text-lg leading-relaxed">
            Need assistance with your account, billing, or subscription? Reach out to our operations team. We typically respond within 24 to 48 hours.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="p-8 rounded-2xl bg-surface-container-low border border-outline-variant/10 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider">Discord HQ</h3>
                    ...
                    <p className="text-xs text-gray-500 mt-1">Live updates and companion guide discussion.</p>
                  </div>
                </div>
              </div>
            </div>

            <div className="p-8 rounded-2xl bg-surface-container-low border border-outline-variant/10 space-y-4">
          ...
          <div className="lg:col-span-3">
            <div className="p-8 md:p-10 rounded-2xl bg-surface-container-low border border-outline-variant/10 relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-lg bg-background border border-outline-variant/20 text-white focus:outline-none focus:border-primary/50 text-sm transition-all"
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-lg bg-background border border-outline-variant/20 text-white focus:outline-none focus:border-primary/50 text-sm transition-all resize-none"
