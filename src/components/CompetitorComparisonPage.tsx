...
export default function CompetitorComparisonPage({ data }: { data: CompetitorData }) {
  ...
  const schemaJsonLd = {
    ...
    "@graph": [
      ...
      { "@type": "Product", name: "Elite FUT SNIPER", description: "The world's first local FC 26 & FC 27 sniping bot, autobuyer, and AI SBC solver Chrome extension.", offers: { "@type": "Offer", price: "29.00", priceCurrency: "USD" }, aggregateRating: { "@type": "AggregateRating", ratingValue: "4.9", ratingCount: "1250" } },
    ],
  };
